...
commentService.create = (post_id, author_id, comment_text) =>{
    return db.none('INSERT INTO comments ( post_id, author_id, comment_text) VALUES (${post_id}, ${author_id}, ${comment_text})', {post_id, author_id, comment_text})
}
...
commentService.update = (id, comment_text) =>{
   return db.none('UPDATE comments SET comment_text = ${comment_text} WHERE id = ${id}', {id, comment_text})
}
